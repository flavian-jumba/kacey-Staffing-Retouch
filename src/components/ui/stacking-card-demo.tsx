...
const projects = [
  ...
  },
  {
    title: 'Mark Rammers',
    description:
      'Dutch photographer Mark Rammers shared the first chapter of his project captured while in residency at an old farm in Los Valles, Lanzarote.',
...
function StackingCardDemo() {
  return <StackingCard projects={projects} />;
}

export { StackingCardDemo };
